...
caminho = 'microdados_ed_basica_2023.csv'  
coluna_filtro = 'SG_UF'
valor_filtro = 'PB'

colunas_selecionadas = ['NO_ENTIDADE','NO_REGIAO', 'CO_UF', 'NO_MUNICIPIO', 'NO_MESORREGIAO', 'NO_MICRORREGIAO', 'QT_MAT_BAS','QT_MAT_INF','QT_MAT_FUND','QT_MAT_FUND_AF','QT_MAT_MED','QT_MAT_PROF','QT_MAT_EJA','QT_MAT_ESP']
